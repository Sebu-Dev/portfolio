                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1
                            ...
                            initial="hidden"
                            animate="visible"
                            transition={{ duration: 0.5, delay: 1 }} className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl ">Florian Sebulke</motion.h1>
                        <motion.span
                ...
                <div className="w-full lg:w-1/2 lg:p-8">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            className="rounded-3xl w-3/4 " src={profilPic} alt="profilPic" />
                    </div>
                </div>
            </div>
        </div >
